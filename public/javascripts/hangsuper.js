	  ...
	  function AddDays(){
	    ...
	    for(var i = 0; i < calendar.Selected.Days; i++){
	      ...
	      for(var n = 0; n < calendar.Model.length; n++){
	        var evDate = hs.sqlToJsDate(calendar.Model[n].Date);
	        ...
	        if(evDate.getTime() == toDate.getTime()){
	          ...
	          if(typeof calendar.Model[n].Link == 'function' || calendar.Options.EventClick){
	            ...
	            title.appendChild(a);
	          	...
	          	//////////must write a showDetail(self) function to handle click logic/////////////////// 
	            


	            title.innerHTML += '<div id = "'+calendar.Model[n].Link+'" class="dateEvent" onclick="showDetail(this);">'+ calendar.Model[n].Title + '</div>';
